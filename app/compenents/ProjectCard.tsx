      ...
      >
        ...
        >
          ...
          (
            <Link
              href={preview}
              className="border-2 hover:white rounded-full border-[#ADB7BE] hover:border-white"
            >
              <EyeIcon className="h-10 text-[#ADB7BE] hover:text-white" />
            </Link>) 
          }
          <Link
            href={githubUrl}
            className="border-2 hover:text-white rounded-full border-[#ADB7BE] hover:border-white"
          >
            <CodeBracketIcon className="h-10 text-[#ADB7BE] hover:text-white" />
          </Link>
        </div>
      </div>
